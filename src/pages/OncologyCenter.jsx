...
const OncologyCenter = () => {
    const [tab, setTab] = useState("overview");
    return (
        <div className='bg-bgcolor pb-20'>
            <CoverSection title={"TRUNG TÂM UNG BƯỚU"} />
        ...
        ${tab === item
                    ...
                    <p className="text-gray-700 leading-relaxed pb-5">
                        HyCare quản lý và điều trị ung thư với sự tham gia trực tiếp của đội ngũ chuyên gia, áp dụng mô hình đa chuyên khoa, cá thể hóa phác đồ theo từng người bệnh. Trung tâm chú trọng chuẩn hóa điều trị dựa trên bằng chứng và y học chính xác, hướng tới mục tiêu trở thành Trung tâm Ung bướu Xuất sắc (COE) hàng đầu tại Việt Nam.
                    </p>
                    ...
                    <div className="px-10 bg-white text-gray-700 leading-7 text-lg">
                            ...
                            <div className="">
                                <ImageLeftContentRight imageSrc="/emergency/emergency_1.jpg">
                                    <div className="space-y-3">
                                        <UnderlinedTitle title="Mô hình điều trị đa thức" />
                                        <p className="text-gray-700 leading-relaxed">
                                            Đây là cách tiếp cận tiên tiến được HyCare áp dụng trong điều trị ung thư, đảm bảo hiệu quả cao xuyên suốt từ chẩn đoán, điều trị đến theo dõi sau điều trị. Quá trình chẩn đoán được thực hiện kỹ lưỡng với các xét nghiệm hiện đại như PET/CT, SPECT/CT, MRI, sinh thiết, hóa mô miễn dịch và sinh học phân tử.
                                        </p>
                                        <p className="text-gray-700 leading-relaxed">
                                            Khi có chỉ định điều trị, HyCare triển khai phác đồ đa mô thức theo chuẩn quốc tế, kết hợp phẫu thuật, xạ trị, hóa trị, ghép tế bào gốc tạo máu, điều trị đau và chăm sóc giảm nhẹ, tuân thủ các hướng dẫn lâm sàng cập nhật của các hiệp hội ung thư uy tín trên thế giới.
                                        </p>
                                    </div>
                        ...
                        {tab === "doctors" && (
                            <div className='py-10'>
                                <UnderlinedTitle title="Đội ngũ bác sĩ Trung tâm Ung bướu" />
                                <div className='mt-10'>
                                    <DoctorList specialtyKey="oncology-center" />
                                </div>
                            </div>
                        )}
